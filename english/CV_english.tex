...
\cvpersonalinfo{
    ...
    \cvpersonalinfolinewithicon{height=4mm}{github.pdf}{
        \href{https://github.com/LeonardoSalicari}{github.com/LeonardoSalicari}
    }
...
\cvitem{
    ...
    \cvdurationfont{Ph.D. at University of Padua, Department of Physics and Astronomy "Galileo Galilei"}

    Supervisor: Prof. Antonio Trovato\\
    Topic: Statistical Mechanics and numerical simulations of topologically entangled proteins

    Fields of research: Statistical Mechanics, Computational Biology, Complex Systems
}


% children's chaperone
\cvitem{
    \cvdurationstyle{June 2015 - July 2019}
}{
    \cvtitle{Children's chaperone}

    \cvdurationfont{Soggiorni TIM: Colleverde Summer Camps, Colle Umberto, Perugia, Italy}
}
...
\cvitem{
    ...
    \cvdurationfont{Università degli Studi di Padova, Padua, Italy} % use \cvdurationfont instead of \textit in order to use the correct font in italic
...
\cvitem{
    ...
    \cvdurationfont{Università degli Studi di Perugia, Perugia, Italy}
...
\cvitem{
    ...
    Programming languages: C++, Python, and \LaTeX\\
    Interests in Data Analysis and Data Visualization\\
...
\cvitem{
    ...
    \cvheadingstyle{Basic course on cardiovascular resuscitation}\\
    Delivered by \cvdurationfont{Padova fa battere il cuore}

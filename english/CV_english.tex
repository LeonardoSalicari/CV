...
\cvitem{
    ...
    \cvdurationstyle{University of Padua, Department of Physics and Astronomy "Galileo Galilei"}
    ...
    Major research interests: Statistical Mechanics, Computational Biology, Complex Systems
}
...
\cvitem{
    ...
    \cvdurationstyle{Soggiorni TIM: Colleverde Summer Camps, Colle Umberto, Perugia, Italy}
}

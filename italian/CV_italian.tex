...
\cvpersonalinfo{
    ...
    \cvpersonalinfolinewithicon{height=4mm}{072-location.pdf}{
        Via Eugubina 121, 06125, Perugia (Italia)
    }
...
\cvitem{
    ...
    \cvtitle{Laurea Magistrale in Fisica}
    ...
    \begin{itemize}[leftmargin=*]
        \item Percorso in Fisica dei Sistemi Complessi
        \item Titolo di Tesi: ``Folding Mechanisms of Entangled Proteins''
        \item Voto: 
        110 cum laude
    \end{itemize}
}
...
\cvitem{
    ...
    \cvheadingstyle{Programmazione}\\
    Competenze in C++, Python e \LaTeX\\
    Interesse nella Data Science: Data Analysis e Visualization\\

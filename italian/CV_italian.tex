...
\cvpersonalinfo{
    ...
    \cvpersonalinfolinewithicon{height=4mm}{072-location.pdf}{
        Via Curzola 10, 35135, Padova (Italia)
    }
...
% master's
\cvitem{
    \cvdurationstyle{Ottobre 2018 - Alla data attuale}
}{
    \cvtitle{Laurea Magistrale in Fisica della Materia}
